<?php
  ...
  class GoogleLinks extends \ClicShopping\OM\Modules\AdminDashboardAbstract
  {
    ...
    public function getOutput()
    {
      ...
      $output .= '  <tr>' .
        '    <td colspan="2"><a href="' . $url_analytics . '" target="_blank" rel="noopener">' . $this->app->getDef('module_admin_dashboard_googlelinks_app_analytics') . '</a></td>' .
        '  </tr>' .
        '  <tr>' .
        '    <td colspan="2"><a href="' . $url_webmastertools . '" target="_blank" rel="noopener">' . $this->app->getDef('module_admin_dashboard_googlelinks_app_webmastertools') . '</a></td>' .
        '  </tr>' .
        '  <tr>' .
        '    <td colspan="2"><a href="' . $url_places . '" target="_blank" rel="noopener">' . $this->app->getDef('module_admin_dashboard_googlelinks_app_places') . '</a></td>' .
        '  </tr>' .
        '  <tr>' .
        '    <td colspan="2"><a href="' . $url_alerts . '" target="_blank" rel="noopener">' . $this->app->getDef('module_admin_dashboard_googlelinks_app_alerts') . '</a></td>' .
        '  </tr>' .
        '  <tr>' .
        '    <td colspan="2"><a href="' . $url_adsense . '" target="_blank" rel="noopener">' . $this->app->getDef('module_admin_dashboard_googlelinks_app_adsense') . '</a></td>' .
        '  </tr>' .
        '  <tr>' .
        '    <td colspan="2"><a href="' . $url_adwords . '" target="_blank" rel="noopener">' . $this->app->getDef('module_admin_dashboard_googlelinks_app_adwords') . '</a></td>' .
        '  </tr>' .

        '  <tr>' .
        '    <td colspan="2"><a href="' . $url_merchant . '" target="_blank" rel="noopener">' . $this->app->getDef('module_admin_dashboard_googlelinks_app_merchant') . '</a></td>' .
        '  </tr>';
